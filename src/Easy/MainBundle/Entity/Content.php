...
//    }
    ...
    public static function getTypes()
    {
        return array(
            ...
            'news' => 'Слайдер новостей', // блок новости ?
            /*'calendar' => 'Блок календаря', // календарь событий в гашей жизни*/
            'video_gallery' => 'Видеогалерея', //видео галлерея
//            'news_all' => 'news_all', //все новости в нашей жизни подробнее
//            'calendar_all' => 'calendar_all', //все события календаря в подробнее
            'photo_links' => 'Ссылки на фотоальбомы', // ссылки фотогаллерей на фотки непосредственно
